...
- Charging starts, charging-related wakes, current changes, and charging-limit changes require the configured cable sensor to be positively ON. OFF, unknown, unavailable, or missing cable data fails closed. A positively active charge may still receive a no-wake safety stop.
